  ...
  return (
    <footer style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          {/* Logo & Description */}
          <motion.div className="md:col-span-2" variants={colVariants}>
            <div className="flex items-center gap-3 mb-4">
              <img src={logo} className="h-8 sm:h-9 md:h-10 lg:h-12 w-auto max-w-[120px] sm:max-w-[140px]" alt="IBA Performance" />
            </div>
            <p style={{
            ...
            <div className="flex gap-3">
              {settings?.instagram && (
                ...
                >
                  <svg role="img" style={{ width: '16px', height: '16px' }} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
