...
export default function HeroSection() {
  ...
  const stats = useMemo(() => [
    ...
    { icon: TrendingUp, value: "98%", label: "Clients satisfaits" },
  ], []);
          ...
          */}
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 tracking-tight">
            ...
            <span className="text-white">
              au service de votre moteur
            </span>
          </h1>

          {/* Description */}
          <p className="text-lg md:text-xl text-zinc-300 mb-8 max-w-2xl mx-auto leading-relaxed">
            Spécialiste de la reprogrammation moteur, préparation circuit et optimisation de performances. 
            Libérez le véritable potentiel de votre véhicule.
          </p>
