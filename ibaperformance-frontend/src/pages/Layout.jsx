            ...
            <div className="md:col-span-2">
              ...
              <div className="flex gap-4">
                {settings?.instagram && (
                  ...
                  >
                    <svg role="img" className="w-5 h-5 text-zinc-300" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-sm text-zinc-400">
                  ...
                  >
                    {settings?.telephone || "+33 1 23 45 67 89"}
                  </a>
                </li>
                <li className="flex items-center gap-2 text-sm text-zinc-400">
                  ...
                  <a 
                    ...
                    className="hover:text-zinc-200 transition-colors"
                  >
                    {settings?.email || "contact@ibaperformance.fr"}
                  </a>
                </li>
              </ul>
            </div>
